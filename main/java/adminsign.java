...
public class adminsign extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(233, 228, 25));

        jPanel2.setBackground(new java.awt.Color(4, 5, 5));

        jLabel2.setFont(new java.awt.Font("Ubuntu Medium", 1, 36)); // NOI18N
        ...
        jLabel3.setForeground(new java.awt.Color(36, 15, 15));
        jLabel3.setText("ADMIN NAME");

        jLabel4.setForeground(new java.awt.Color(5, 5, 5));
        jLabel4.setText("HOST ID");

        jTextField1.setBackground(new java.awt.Color(221, 229, 246));
        jTextField1.setForeground(new java.awt.Color(19, 7, 7));
